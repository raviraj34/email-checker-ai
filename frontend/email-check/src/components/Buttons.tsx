...
const Button = () => {
  return (
    <ul className="flex justify-center mt-5 space-x-5">
      <li>
        <a href='https://x.com/rrs_365' className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
      ...
      <li>
        <a href='https://github.com/raviraj34' className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
          <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
